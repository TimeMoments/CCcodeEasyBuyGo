				...
				<div class="graphs">
					<div class="sign-in-form">
						...
						<div class="signin">
							...
							<form name="managerForm" action="<%=request.getContextPath() %>/login.do?method=login" method="post" focus="name" onsubmit="return doForm()">
								<div class="log-input">
									<div class="log-input-left">
									   <input type="text" class="user" name="name" value="用户名/邮箱" onfocus="this.value = '11';" onblur="if (this.value == '') {this.value = '用户名/邮箱';}"/>
									</div>
								...
								<div class="log-input">
									<div class="log-input-left">
									   <input type="password" class="lock" name="pass" value="password" onfocus="this.value = '11';" onblur="if (this.value == '') {this.value = '用户名/邮箱';}"/>
									</div>
									<span class="checkbox2">
										 <label class="checkbox"><input type="checkbox" name="checkbox" checked=""><i> </i></label>
									</span>
							...
							<div class="signin-rit">
								...
								<p><a href="#">忘记密码</a> </p>
								<div class="clearfix"> </div>
								<a href="<%=request.getContextPath() %>/jsps/login/managerlogin.jsp" style="font-size: 12px;position:absolute;left: 75%">进入后台管理</a>
							</div>
						</div>
