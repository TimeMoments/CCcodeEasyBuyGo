					  ...
					  <div id="myTabContent" class="tab-content">
						<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						   <div>
								...
								<div class="clearfix"></div>
							<ul class="list">
							<c:forEach items="${list_commodity}" var="map">
								<a href="<%=request.getContextPath()%>/jsps/commodityR.do?method=queryone&commodity_id=${map.commodity_id}">
									<li>
									<img src="<%=request.getContextPath()%>/category.do?method=download&id=${map.commodity_id}" title="" alt="" />
									<section class="list-left">
									<h5 class="title">${map.commodity_name}</h5>
									<span class="adprice">￥${map.commodity_price}</span>
									<p class="catpath">${map.commodity_remark}</p>
									</section>
									<section class="list-right">
									<span class="date">${map.commodity_time}</span>
