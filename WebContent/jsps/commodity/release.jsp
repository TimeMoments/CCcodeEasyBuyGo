			...
			<div class="fbneirong">
			  ...
			  -->   
			    ...
			    <div class="am-form-group am-cf">
			      ...
			      <div class="you">
			       <input type="text" name="commodity_price"class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入">
			      </div>
			    </div>
			    ...
			    <div class="am-form-group am-cf">
			      ...
			      <div class="you">
			       <input type="text" name="commodity_degree"class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入">
			      </div>
			    </div>
			    <div class="am-form-group am-cf">
			      <div class="zuo">数量：</div>
			      <div class="you">
			       <input type="text" name="commodity_num"class="am-input-sm" id="doc-ipt-email-1" placeholder="请输入">
			      </div>
			    </div>
