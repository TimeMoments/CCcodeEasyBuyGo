					...
					<div class="am-container header">
						...
						<ul class="message-r">
							<div class="topMessage home">
								<div class="menu-hd">
									<a href="<%=request.getContextPath() %>/indextow.jsp" target="_top" class="h">商城首页</a>
								</div>
							</div>
							
							<div class="topMessage my-shangcheng">
								<div class="menu-hd MyShangcheng">
									<a class="person_green" href="<%=request.getContextPath() %>/jsps/User/personalCenter .jsp" target="_top"><i class="am-icon-user am-icon-fw"></i>个人中心</a>
								</div>
							</div>
							...
							<div class="topMessage mini-cart">
								<div class="menu-hd">
									<a id="mc-menu-hd" href="#" target="_top">
										...
										<a href="<%=request.getContextPath()%>/jsps/shopingCar/shoppingCart.jsp">购物车</a>
				...
				<div class="footer">
					...
					<div class="footer-bd">
						<p>
							...
							<a href="#">联系我们</a>
							<a href="#">网站地图</a>
							<em>© 2020-2025 XXXX 版权所有 <a href="http://www.cssmoban.com/" target="_blank" title="版权所有">版权所有</a> - Collect from</em>
						</p>
					</div>
				</div>
